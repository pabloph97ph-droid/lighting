  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="z-10 flex items-center space-x-2 border border-[#E8E3D8] bg-[#F5F2EB]/60 backdrop-blur-sm px-4 py-1.5 rounded-full"
      >
      ...
      <div className="z-10 flex flex-col items-center justify-center my-auto w-full max-w-xl text-center">
        ...
        <motion.div
          ...
          className="mt-7 max-w-md space-y-2.5"
        >
          <p className="font-['Cinzel',serif] text-lg sm:text-xl font-medium tracking-[0.16em] text-[#22242A] uppercase">
            THE WORLD IS WAITING.
          </p>
          <p className="font-['Plus_Jakarta_Sans',sans-serif] text-sm sm:text-base text-[#615B52] leading-relaxed font-normal">
            Descubra o que o inglês pode desbloquear na sua vida.
          </p>
        </motion.div>
        ...
        >
          ...
          >
            <span className="relative z-10">COMEÇAR MINHA EXPERIÊNCIA</span>
      ...
      >
        Instituição de Comunicação Global & Liderança
      </motion.div>
    </div>
  );
};
